...
\end{trditev}
\begin{dokaz}
  Če uporabimo \(\alpo*\) na \(x\) in \(-x\) dobimo želeno formulo. Obratno pa
...
Dedekindova realna števila. Od tu naprej prosto menjamo med \(\alpo*\) in
\(\lpo*\) po potrebi, brez posebne omembe.
