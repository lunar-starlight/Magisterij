...
\newcommand{\definstance}[1]{\@definstance{#1}{\uppercase{#1}}{\lowercase{#1}}}
\newcommand{\instance}[1]{\textnormal{\sffamily #1}} % TODO: rename
\definstance{lem}
\definstance{lpo}
\definstance{alpo}
%\newcommand{\lem}{\instance{LEM}}
% \newcommand{\lpo}{\instance{LPO}}
% \newcommand{\alpo}{\instance{ALPO}}
% \newcommand{\lpoR}{\instance{LPO}_ℝ} % TODO: deprecate
