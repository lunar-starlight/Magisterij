...
\begin{trditev}\label{th:ℒmor-into-compl-is-map}
  ...
  Poleg tega velja tudi \(⊢ a = a' ⇒ φ(a) = φ(a')\), in enakost drži kadar je
  \(a = a'\).
\end{trditev}
\begin{dokaz}
...
\end{konstrukcija}
\begin{dokaz}
  Pokazati je treba, da je evaluacijska preslikava kot mora biti.
\end{dokaz}
...
\begin{dokaz}
  ...
  trditev~\ref{th:ℒ-sub-is-sub} in~\ref{th:ℒ-sub-is-map-to-Ω}.
\end{dokaz}
...
\begin{konstrukcija}
  ...
  Prav tako je \(\pi{a : A}{Bₐ}\) z enakostjo \(\i{f, g} ≔ \)
\end{konstrukcija}
% \begin{lema}
...
Najprej pa konstruirajmo še vsote \(ℒ\)-množic, saj jih potrebujemo v dokazu.
\begin{konstrukcija}
