...
Spodnji rezultat je v malo drugačni obliki pokazal Alex Simpson~\ref{Simpson24},
...
Ta lastnost o pofinitvah pa ni zares klasična topološka lastost. 
...
\begin{dokaz}
  ...
  \(P_α\) tvorijo pokritje, in so paroma disjunktni, to dobro definra term tipa \(X\).
\end{dokaz}
\begin{opomba}
