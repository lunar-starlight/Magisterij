\section{Principi izbire}\label{sec:izbire}
...
Spodnji rezultat je v malo drugačni obliki pokazal Alex Simpson, dokaz v primeru
...
Znana je tudi delna karakterizacija \(\DC\)~\cite[izr.~D4.5.16]{Johnstone02}\cite{HL16}.
\begin{definicija}
